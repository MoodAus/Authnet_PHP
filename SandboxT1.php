...
function getCustomerPaymentProfile($customerProfileId="1811466738", 
    $customerPaymentProfileId= "1806024653"
) {
    /* Create a merchantAuthenticationType object with authentication details
       retrieved from the constants file */
    $merchantAuthentication = new AnetAPI\MerchantAuthenticationType();
    $merchantAuthentication->setName(\SampleCode\Constants::4WpGSN98w7);
    $merchantAuthentication->setTransactionKey(\SampleCode\Constants::7euE9673uK4q9V7G);
